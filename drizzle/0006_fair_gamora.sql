...
INSERT INTO `__new_Applicants`("id", "jobRoleID", "applicantID", "cvPath", "applicationStatus", "appliedAt") SELECT "id", "jobRoleID", "applicantID", "cvPath", "applicationStatus", "appliedAt" FROM `Applicants`;--> statement-breakpoint
